...
se fokusirajmo na <em>LEMP (Linux, [E]Nginx, Mysql, Php, Python, Perl)…</em>
...
<p>
zatim linkovati default vhost podešavanja, mada nginx automatski linkuje, ali za svaki slučaj:</p>
<code>sudo ln -s /etc/nginx/sites-available/default /etc/nginx/sites-enabled/default</code>
<p>zatim editovati /etc/init.d/php-fastcgi i ubaciti sledeći sadržaj:</p>
