...
<img src="./git1-slika1.png" alt="Slika 1" />
<p><b>Slika 1</b></p>
<ul><li>Korisničko ime koji odaberemo može sadržati samo slova engleskog alfabeta i brojeve. Naša (srpska) slova nisu dozvoljena.</li>
<li>Elektronska pošta (e-mail) nam treba radi verifikacije.</li>
<li>Lozinka mora imati najmanje 7 karaktera i sadržati bar jedan broj.</li></ul>
...
<p>Pri vrhu stranice, pored linka do našeg profila se nalazi dugme <img src="git1-slika2.png" width="16px" height="auto" alt="Slika 2" /> uz pomoć kojeg pravimo novi repozitorijum. Možemo napraviti repozitorijum odlaskom na <a href="https://github.com/new">github.com/new</a>. Sada podešavamo repozitorijum.</p>
<ul><li>Polje Owner (vlasnik) ostavljamo isto (kasnije ćemo govoriti o timovima) - pretpostavićemo da je vlasnik naloga „korisnik“</li>
<li>Polje Repository name (ime repozitorijuma) „popunjavamo“ kratkim i zanimljivim nazivom (na primer „moj repozitorijum“)</li>
<li>Polje Description (opis) možemo ostaviti praznim, ipak, ako želimo, možemo ga popuniti</li>
<li>Uvek biramo Public repo</li>
<li>„Initialize this repository with a README“ čekirati</li>
<li>Add .gitignore - najbolje je da ostavimo None</li></ul>
<p>Gotovo! Naš prvi repozitorijum je napravljen!</p>

<p>Kako funkcionišu linkovi na GitHub-u? Svaki korisnik ima svoj direktorijum. Dakle, <a href="https://github.com/korisnik">github.com/korisnik</a> će nas odvesti do profila određenog korisnika. Svaki repozitorijum je kao poddirektorijum. Na primer <a href="https://github.com/korisnik/repo">github.com/korisnik/repo</a>.</p>
...
<p>Ukoliko ne želimo da pristupamo preko HTTPS protokola, tu je SSH koji je dokazano sigurniji. Za SSH pristup Git-u nam je potreban SSH ključ. Ovaj tutorijal će nam pomoći oko pravljenja SSH ključeva → <a href="https://help.github.com/articles/generating-ssh-keys">help.github.com/articles/generating-ssh-keys</a>.</p>
...
<b>repository</b> - direktorijum gde je Git inicijalizovan za pokretanje verzije<br /> kontrole naših datoteka; skraćeno se naziva repo<br />
...
<p><b>Napomena:</b> Ukoliko negde unosite ime direktorijuma, morate staviti kosu crtu (/) posle imena direktorijuma da bi ga Git prepoznao kao direktorijum i izbegao konflikte sa datotekama istog imena.</p>

<h5>Komande</h5>

<b>ssh -T git@sajt.tld</b> - koristi se za autentifikaciju putem SSH ključa koji ste prethodno dodali na nalog (sajt.tld bi trebalo zameniti sa domenom stranice, na primer <em>github.com</em>)<br />
...
<b>git status</b> - pregleda datoteke koje su promenjene, obrisane i dodate u trenutnom direktorijumu i prikazuje njihovo stanje<br />
